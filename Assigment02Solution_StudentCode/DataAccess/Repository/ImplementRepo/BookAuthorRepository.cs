...
namespace DataAccess.Repository.ImplementRepo
{
    public class BookAuthorRepository : IBookAuthorRepository
    {
        ...
        public async Task DeleteBookAuthorAsync(int authorId, int bookId) 
            => await BookAuthorDAO.Instance.DeleteBookAuthorAsync(authorId, bookId);

        public async Task<BookAuthor> GetBookAuthorAsync(int authorId, int bookId) 
            => await BookAuthorDAO.Instance.GetBookAuthorAsync(authorId, bookId);

        public async Task<IEnumerable<BookAuthor>> GetBookAuthorsAsync() 
            => await BookAuthorDAO.Instance.GetBookAuthorsAsync();
